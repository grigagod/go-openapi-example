...
func (s *PaymentsAPIService) CreateBookingPayment(ctx context.Context, bookingId string, bookingPayment BookingPayment) (ImplResponse, error) {
	...
	return Response(http.StatusNotImplemented, nil), errors.New("CreateBookingPayment method not implemented")
}
