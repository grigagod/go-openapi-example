...
// AssertLinksOriginRequired checks if the required fields are not zero-ed
func AssertLinksOriginRequired(obj LinksOrigin) error {
	return nil
}

// AssertLinksOriginConstraints checks if the values respects the defined constraints
func AssertLinksOriginConstraints(obj LinksOrigin) error {
	return nil
}
