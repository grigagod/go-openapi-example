...
// AssertGetBookings200Response1Required checks if the required fields are not zero-ed
func AssertGetBookings200Response1Required(obj GetBookings200Response1) error {
...
// AssertGetBookings200Response1Constraints checks if the values respects the defined constraints
func AssertGetBookings200Response1Constraints(obj GetBookings200Response1) error {
	for _, el := range obj.Data {
