...
// AssertGetTrips200Response1Required checks if the required fields are not zero-ed
func AssertGetTrips200Response1Required(obj GetTrips200Response1) error {
...
// AssertGetTrips200Response1Constraints checks if the values respects the defined constraints
func AssertGetTrips200Response1Constraints(obj GetTrips200Response1) error {
	for _, el := range obj.Data {
